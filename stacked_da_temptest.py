...
class SdA(object):
    ...
    def dump(self,f_dump):
        ...
        #params of relevance: sigmoid and out_sigmoid's W and b, logistic layer's W and b.
        ...
        for layer in self.sigmoid_layers:
            hidden_paramdicts.append({'W': layer.W.get_value(),
                                  ...
                                  'n_in': layer.n_in,
                                  'n_out': layer.n_out})
        log_paramdict = {'W': self.logLayer.W.get_value(),
                      'b': self.logLayer.b.get_value()}
        
        param_dict = {'hidden_paramdicts':hidden_paramdicts,
                      'log_paramdict':log_paramdict}
    ...
    def load(self,f_load):
        ...
        hidden_paramdicts = param_dict['hidden_paramdicts']
...
def test_SdA(finetune_lr=0.1, pretraining_epochs=1,#15,
             pretrain_lr=0.001, training_epochs=1,#1000,
             dataset='mnist.pkl.gz', batch_size=100):#1):
    """
